...
- [ERL]{https://github.com/ndduong1986/RAT-Benchmark/blob/master/algorithms/ERL.m} (Enhanced Reinforcement Learning): a RL algorithm with network-assisted feedback
